...
import type { SensitiveMatch, SensitiveSeverity } from "../../common/sensitive";
import type { SensitiveCategory } from "../../common/sensitive";

/** Secrets always outrank structured PII (40–55) and named entities (30) when
 *  two matches overlap the same span — a leaked credential is the worst case. */
export const SECRET_RANK = 90;
const SECRET_SEVERITY: SensitiveSeverity = "high";

export const PRESET_RULE_ID = "@secretlint/secretlint-rule-preset-recommend";
export const PATTERN_RULE_ID = "@secretlint/secretlint-rule-pattern";
export const AWS_RULE_ID = "@secretlint/secretlint-rule-aws";
 ...
 */
export const JWT_PATTERN = "eyJ[A-Za-z0-9_-]{8,}\\.eyJ[A-Za-z0-9_-]{6,}\\.[A-Za-z0-9_-]{6,}";
export const JWT_PATTERN_NAME = "JSON Web Token";
